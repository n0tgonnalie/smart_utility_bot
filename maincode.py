...
@dp.message(F.text.lower() == 'зачем ты нужен?')
async def get_inline_btn_link(message: Message):
    await message.answer('''Я - твой бот-помощник по физике и математике. Хочешь:
• вспомнить, как строить графики функций?
• посчитать на инженерном калькуляторе?
• подготовиться к контрольной по физике с помощью формул?
• или что-то другое?

Без проблем, я с радостью помогу тебе с этими задачами!
Конечно, я не всесилен, и всех знаний мира у меня нет, но мои способности с каждым разом пополняются и в будущем я стану сильнее.
Дальше - больше!''')
